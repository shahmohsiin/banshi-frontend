...
function formatDateTime(input: string): string {
  ...
  const formatAmount = (amount: number) => {
   ...
   let operator = String(amount)
   let del = operator.indexOf("-")
   let newValue = Number(operator.replace("-",""))
   var newtext;
   operator.includes("-")?newtext="-":newtext="+";



    return `${newtext}₹${newValue.toLocaleString('en-IN')}`;
      ...
      <View style={styles.historyItemContent}>
        ...
        <View style={styles.historyItemRight}>
          <Text style={[
            ...
            { color: String(formatAmount(item.amount)).includes("+")? theme.colors.success : theme.colors.error }
