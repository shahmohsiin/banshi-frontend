...
export default function ContactUsScreen() {
  ...
  const handleTelegram = (username: string) => {
    const telegramUrl = `https://t.me/Banshi_royal_group`;
    Linking.openURL(telegramUrl);
  };

  const handleWithdrawProof = () => {
    const whatsappGroupUrl = 'whatsapp://send?phone=9672445574';
  ...
  const contactOptions: ContactOption[] = [
  ...
  
    {
      ...
      onPress: () => handleWhatsApp('9672445574'),
    },

    {
      id: 'telegram',
      title: 'Telegram',
      subtitle: 'https://t.me/Banshi_royal_group',
      icon: 'paper-plane',
      iconColor: theme.colors.blue,
