...
export default function SingleDigitScreen() {
  ...
  // Debug logging
  console.log('SingleDigitScreen - userData:', userData);
  console.log('SingleDigitScreen - gameId:', gameId);
  ...
  const handleAddBid = async () => {
    ...
    if (!digit.trim()) {
      Alert.alert('Error', 'Please enter a single digit');
      return;
    }
    if (!amount.trim()) {
    ...
    if (digit.length !== 1) {
      Alert.alert('Error', 'Please enter exactly 1 digit');
      return;
    }
    if (parseInt(digit) < 0 || parseInt(digit) > 9) {
      Alert.alert('Error', 'Please enter a valid single digit (0-9)');
      return;
    }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Single Digit ({gameName})</Text>
